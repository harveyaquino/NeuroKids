...
export default function Login() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      if (isSignUp) {
        ...
        // onAuthStateChange disparará el redirect via useEffect
      }
    } catch (err) {
  ...
  // Mientras carga la sesión no mostramos nada para evitar flash
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-white border border-gray-300 text-gray-700 rounded-xl font-semibold hover:bg-gray-50 transition-all text-sm shadow-sm"
          >
